				...
				vector<vector<int> > matrix_B)
{
	...
	if (col_1 != row_2) {
		cout << "\nError: Jumlah kolom pada matrik "
				"harus sesuai dengan jumlah baris "
				"Matrik B\n";
		return {};
	}
...
int main()
{
	...
	print("Array Hasil", result_matrix, 0, 0, ROW_1 - 1,
		COL_2 - 1);
}

// Kompleksitas waktu: T(N) = 7T(N/2) + O(N^2) => O(N^Log7)
// yang diperkirakan O(N^2.8074) Code Contributed By:
// lucasletum
